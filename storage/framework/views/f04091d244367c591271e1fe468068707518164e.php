...
<html lang="<?php echo e(app()->getLocale()); ?>">
  ...
  <body class="fixed-left">
      ...
      <div class="left side-menu">
        ...
        <div class="topbar-left">
          <div class="text-center bg-logo">                
            <a href="<?php echo e(url('/home')); ?>" class="logo"><img src="<?php echo e(asset('images/logo.png')); ?>" height="50" alt="logo"></a> 
          </div>
        </div>
        <div class="sidebar-user">
          <img src="<?php echo e(asset('images/user.png')); ?>" alt="user" class="rounded-circle img-thumbnail mb-1">
          <h6 class=""><?php echo e(Auth::user()->nombres); ?> </h6>           
          <ul class="list-unstyled list-inline mb-0 mt-2">
            ...
            <li class="list-inline-item">
              <a href="<?php echo e(route('logout')); ?>" class="" data-toggle="tooltip" data-placement="top" title="Log out" onclick="event.preventDefault();
              ...
              <ul class="list-inline float-right mb-0">                                
                <li class="list-inline-item dropdown notification-list">
                  ...
                  <div class="dropdown-menu dropdown-menu-right dropdown-arrow dropdown-menu-lg">
                    ...
                    <a href="javascript:void(0);" class="dropdown-item notify-item">
                      <div class="notify-icon"><img src="<?php echo e(asset('images/user.png')); ?>" alt="user-img" class="img-fluid rounded-circle" /> </div>
                ...
                <li class="list-inline-item dropdown notification-list">
                  <a class="nav-link dropdown-toggle arrow-none waves-effect nav-user" data-toggle="dropdown" href="#" role="button"
                       aria-haspopup="false" aria-expanded="false">
                    <img src="<?php echo e(asset('images/user.png')); ?>" alt="user" class="rounded-circle">
                  </a>
    ...
    <script src="<?php echo e(asset('pages/validation.init.js')); ?>"></script>

    <script src="<?php echo e(asset('plugins/sweet-alert2/sweetalert2.min.js')); ?>"></script>
    <script src="<?php echo e(asset('pages/sweet-alert.init.js')); ?>"></script>
