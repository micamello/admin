            ...
            <ul>
              ...
              <li class="has_sub">
                ...
                <ul class="list-unstyled">
                  ...
                  <li><a class="active" href="{{ route('candidatos') }}">Lista de Candidatos</a></li>
                  <li><a href="{{ route('empresas') }}">Lista de Empresas</a></li>
                  <li><a href="{{ route('ofertas') }}">Lista de Ofertas</a></li>
                  <li><a href="{{ route('planes') }}">Lista de Planes</a></li>
                </ul>
              </li>
